...
There aren't any instructions provided on how to do this and it requires some trawling through the build system to figure out, so providing the pinmap at least for xc7s50csga324-1 (which I'm using) here.
